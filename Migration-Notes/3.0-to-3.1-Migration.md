...
For more information on how to ensure that your payment module conforms to the new Broadleaf standards, see [[Checkout Page Design]] and [[Payment]]. 
...
<databaseChangeLog xmlns="http://www.liquibase.org/xml/ns/dbchangelog" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.liquibase.org/xml/ns/dbchangelog http://www.liquibase.org/xml/ns/dbchangelog/dbchangelog-3.0.xsd">
    ...
    <changeSet author="liquibase (generated)" id="1390840028609-26">
        <addColumn tableName="BLC_PAYMENT_LOG">
            <column name="ORDER_PAYMENT_REFERENCE_NUMBER" type="VARCHAR(255)"/>
        </addColumn>
    </changeSet>
