...
## REST API Updates
### New Methods
1. POST: /cart/items/{itemId}/options
2. GET: /cart/checkout/payments
3. POST: /cart/checkout/payment
4. DELETE: /cart/checkout/payment
