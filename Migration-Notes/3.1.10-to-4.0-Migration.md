...
1. Remove
  ...
  ```
2. Remove the `<context:component-scan .. />` tags that targeted your REST-API packages. This is now configured in your class that extends from the `BroadleafRestApiMvcConfiguration` class.
